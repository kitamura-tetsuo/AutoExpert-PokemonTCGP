...
class CodeGenerator:
    ...
    def generate(self, goal: str, previous_code: Optional[str] = None, feedback: Optional[str] = None, wait_completion: bool = True, deck_path: Optional[str] = None, deck_contents: Optional[str] = None, opponent_deck_path: Optional[str] = None, opponent_deck_contents: Optional[str] = None) -> str:
        """Calls Jules to generate a Python play function."""
        task_prompt = get_task_prompt(goal, previous_code, feedback, deck_path, deck_contents, opponent_deck_path, opponent_deck_contents)
        
        system_prompt = get_system_prompt(deck_path, opponent_deck_path)
