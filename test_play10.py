    ...
    for aid in legal_actions:
        ...
        if "Attack" in aname:
            ...
            if threat_lethal and is_ko:
                ...
                # BUG is here! If points_gained >= points_lost, we overwrite the score with 550,000 !!
                # And in this case, points_gained (1 from Arbok) is NOT >= points_lost (2 from Venusaur EX)
                # Wait, points_gained (1) >= points_lost (2) is FALSE.
                print(f"Attack {idx} points_gained: {points_gained}, points_lost: {points_lost}")
