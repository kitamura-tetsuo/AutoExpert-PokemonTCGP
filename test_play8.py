...
def play_with_scores(state, game):
    ...
    for aid in legal_actions:
        ...
        if "Attack" in aname:
            ...
            # Threat lethal check is only after checking is_lethal! Let's see original code:
            if threat_lethal and is_ko:
                ...
                # If points_gained >= points_lost, it overrides LETHAL_WIN_SCORE (1000000) with 550000 !!!
